...
var mainState = {
    ...
    create: function() { 
        ...
        //Start text 
        this.labelStart = this.game.add.text(130, 380, "Press S to start!", { font: "27px Arial Black", fill: "#fff", strokeThickness: 6, stroke: "#000"  });
        
        this.labelPress = this.game.add.text(163, 425, "Spacebar to jump", { font: "18px Arial Black", fill: "#fff", strokeThickness: 6, stroke: "#000"  });
},
